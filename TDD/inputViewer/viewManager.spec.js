...
//     it('viewManage에 TextManager의 인스턴스가 잘 전달되었는지 확인합니다.',()=>{
...
//         // 유닛 테스트에서의 actual은 테스트중인 함수 혹은 코드의 변환 값을 의미하는 용어이다.
//         const actual = () => new ViewManager(textManager, {btnEl, inpTxt, viewer});

//         // toThrowError : 코드에서 실제로 에러가 발생하고 있는지 검증
//         expect(actual).toThrowError();
//     });

//     it('viewManager에 option들이 제대로 전달 되었는지 확인합니다.',()=>{
...
//     const viewManager = new ViewManager(textManager,{btnEl,inpTxt,viewer});
